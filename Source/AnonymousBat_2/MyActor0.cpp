...
// Called every frame
void AMyActor0::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AMyActor0::SoundCubeVisualizer_MouseButtonDown_Implementation(UPrimitiveComponent* _ClosestHit)
{
...
void AMyActor0::SoundCubeVisualizer_MouseButtonUp_Implementation(UPrimitiveComponent* _ClosestHit)
{
